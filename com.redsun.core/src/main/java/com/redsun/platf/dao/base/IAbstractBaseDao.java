...
public interface IAbstractBaseDao<T , PK extends Serializable > {
	...
	public abstract List<T> findBy(final String propertyName,
                                   final Object value, final MorePropertyFilter.MatchType matchType);

	/**
	 * 按属性过滤条件列表查找对象列表.
	 */
	public abstract List<T> find(List<MorePropertyFilter> filters);
	/*******************************************************************/
