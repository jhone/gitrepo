...
public class SystemConfiguration {
    ...
    public String toString() {
        return "SystemConfiguration [developerMode=" + developerMode
                + ", mailGeneratorUrl=" + mailGeneratorUrl
                + ", batchMailGeneratorUrl=" + batchMailGeneratorUrl
                + ", mailOutputPath=" + mailOutputPath + ", attachmentPath="
                + attachmentPath + ", signaturePath=" + signaturePath
                + ", tempFilePath=" + reportTemplateFilePath + ", reportTemplateFilePath="
                + reportFilePath + ", reportSourcePath=" + reportSourcePath
                + ", jcoLogXMLPath=" + jcoLogXMLPath + ", overdueDays="
                + overdueDays + ", wsAccount=" + wsAccount + ", wsPassword="
                + wsPassword + ", pwdErrorTimes=" + pwdErrorTimes
                + ", pwdEffective=" + pwdEffective + ", pwdUseTimes="
                + pwdUseTimes + "]";
    }
