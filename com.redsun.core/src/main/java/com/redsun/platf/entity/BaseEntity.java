...
//error format import java.util.Date;
 ...
 * @author Jason Huang
 * @version 1.0
 * @Author P.Y.C  2012/12/17 bugfixed for json prase JsonIgnoreProperties
...
public abstract class BaseEntity extends IdEntity implements Serializable {
    ...
    @DateTimeFormat(pattern = EPApplicationAttributes.DATE_FORMAT)
