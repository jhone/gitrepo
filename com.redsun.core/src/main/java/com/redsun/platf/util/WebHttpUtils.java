 ...
 * ------- ---------  ------------  ---------------------------------------------------
 * 1.0     13-8-29    joker pan    created
 * <pre/>
 */
public class WebHttpUtils {

public static final Logger logger=   LogUtils.getLogger(WebHttpUtils.class);
   	...
   	public static String doPost(String url, String ctype, byte[] content,int connectTimeout,int readTimeout) throws IOException {
   		...
   		try {
   			try{
                ...
                logger.error("error:{} ,key:{},method:{},content:{}",
                        e, url, map.get("app_key"), map.get("method"), content);
   				throw e;
   			}
   			try{
   				...
   				Map<String, String> map=getParamsFromUrl(url);
                logger.error("error:{} ,conn:{},method:{},content:{}",
                        e, conn, map.get("app_key"), map.get("method"), content);
   				throw e;
   			}
...
//   				AlipayLogger.logCommError(e, url,map.get("app_key"),map.get("method"), params);
                logger.error("error:{} ,key:{},method:{},params :{}",
                                        e, url,map.get("app_key"),map.get("method"), params );
   				throw e;
   			}
...
//   				AlipayLogger.logCommError(e, conn,map.get("app_key"),map.get("method"), params);
                logger.error("error:{} ,conn :{},method:{},content:{}",
                                        e, conn,map.get("app_key"),map.get("method"), params );
   				throw e;
   			}
...
//   				AlipayLogger.logCommError(e, conn,map.get("app_key"),map.get("method"), params);
   	...
   	public static String buildQuery(Map<String, String> params, String charset) throws IOException {
   		...
   		for (Map.Entry<String, String> entry : entries) {
               ...
               // 忽略参数名或参数值为空的参数
   			if (StringUtils.isNotEmpty(name) && StringUtil.isNotEmpty(value)) {
   				if (hasParam) {
   					query.append("&");
   				} else {
   					hasParam = true;
