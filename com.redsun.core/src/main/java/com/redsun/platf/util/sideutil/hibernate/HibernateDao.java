package com.redsun.platf.util.sideutil.hibernate;
...
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
	 ...
	 */
	public List<T> findBy(final String propertyName, final Object value, final MorePropertyFilter.MatchType matchType) {
	 ...
	 * 按属性过滤条件列表分页查找对象.
	 */
	public Page<T> findPage(final Page<T> page, final List<MorePropertyFilter> filters) {
		Criterion[] criterions = buildCriterionByPropertyFilter(filters);
	...
	protected Criterion buildCriterion(final String propertyName,
                                       ...
                                       final MorePropertyFilter.MatchType matchType) {
	 ...
	 */
	protected Criterion[] buildCriterionByPropertyFilter(final List<MorePropertyFilter> filters) {
