...
@Deprecated //see MorePropertyFilter
public class PropertyFilter_old {
	 ...
	 * @param value 待比较的值.
	 */
	public PropertyFilter_old(final String filterName, final String value) {
		...
		propertyNames = StringUtils.splitByWholeSeparator(propertyNameStr, PropertyFilter_old.OR_SEPARATOR);
	 ...
	 */
	public static List<PropertyFilter_old> buildFromHttpRequest(final HttpServletRequest request) {
	 ...
	 */
	public static List<PropertyFilter_old> buildFromHttpRequest(final HttpServletRequest request, final String filterPrefix) {
		List<PropertyFilter_old> filterList = new ArrayList<PropertyFilter_old>();
		...
		for (Map.Entry<String, Object> entry : filterParamMap.entrySet()) {
			...
			if (StringUtils.isNotBlank(value)) {
				PropertyFilter_old filter = new PropertyFilter_old(filterName, value);
