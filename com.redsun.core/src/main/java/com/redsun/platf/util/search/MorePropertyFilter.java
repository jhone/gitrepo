...
import com.redsun.platf.util.sideutil.ServletUtils;
 ...
 * @author calvin
 */
public class MorePropertyFilter {
    /**
     * 多个属性间OR关系的分隔符.
     */
    ...
    public enum PropertyType {
        S(String.class), I(Integer.class), L(Long.class), N(Double.class), D(Date.class), B(Boolean.class), T(Timestamp.class);
     ...
     * @param value      待比较的值.
     */
    public MorePropertyFilter(final String filterName, final String value) {
        ...
        propertyNames = StringUtils.splitByWholeSeparator(propertyNameStr, MorePropertyFilter.OR_SEPARATOR);
     ...
     */
    public static List<MorePropertyFilter> buildFromHttpRequest(final HttpServletRequest request) {
     ...
     */
    public static List<MorePropertyFilter> buildFromHttpRequest(final HttpServletRequest request, final String filterPrefix) {
        ...
        for (Map.Entry<String, Object> entry : filterParamMap.entrySet()) {
            ...
            if (StringUtils.isNotBlank(value)) {
                MorePropertyFilter filter = new MorePropertyFilter(filterName, value);
